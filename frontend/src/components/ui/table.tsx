...
/** Dense data table primitives (design system: Data-Dense Dashboard, ~36px rows). */
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "sticky top-0 bg-muted/60 text-left text-xs uppercase tracking-wide text-muted-foreground",
      className,
    )}
    {...props}
  />
